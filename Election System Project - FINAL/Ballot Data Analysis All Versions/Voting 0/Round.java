...
public class Round {
	...
	public Round(ArrayList<Vote> master, ArrayList<Candidate> candidates, ArrayList<Candidate> winningCandidates, int numOfWinners) {
		this.master = master;
	...
	public void printResults() {
		...
		String c = "Ballots Exhausted: " + votesLost;
...
//			}
		...
		String f = "Majority needed: " + round(majority);
	...
	public void checkForWinner() {
		...
		if(winner.getVoteScore() >= majority) {
			...
			if(winningCandidates.size()==numOfWinners) {
				...
				roundData.add("");
				roundNumber++;
				new Round(nextRoundList, this.candidates, this.winningCandidates, this.numOfWinners);
			}
		} else {
			redistributeLoser();
