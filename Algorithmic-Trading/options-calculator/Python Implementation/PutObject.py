...
# -*- coding: utf-8 -*-
"""
Created on Thu May 14 16:16:55 2020
...
class Put(Option):
    """
    A Put object which implements the Option class as a parent class.
    """
    
        
    def __init__(self, underlying_symbol, underlying_price, info_series, is_long):
        """
        Initializes the Put instance.
    ...
    def calculate_description(self):
        """
        Calculates the description of this put: (ITM, ATM, OTM).
    ...
    def calculate_breakeven_price(self):
        ...
        -------
        'float'
            The breakeven price point for this put.
